...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    private static final String DATABASE_NAME1 = "student_db";
    ...
    public void insertStudent(String id, String student){
        ...
        values.put(Student.COLUMN_NAME1, student);
    ...
    public Student getStudent(String id) {
        ...
        Student student = new Student(
                ...
                cursor.getString(cursor.getColumnIndex(Student.COLUMN_NAME1)));
        cursor.close();
        return student;
    }
